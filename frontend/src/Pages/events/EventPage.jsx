        ...
        <div className='flex justify-center w-[80%] h-full p-6 bg-white rounded-xl shadow-lg space-x-8'>
            <div className='flex flex-col items-start justify-start w-[60%] h-full p-8 space-y-8'>
                <div className='space-y-3'>
                    <h1 className='text-4xl font-bold text-gray-900'>Tech Conference 2024</h1>
                    <p className='text-lg text-gray-600 flex items-center'>
                        <span className='mr-2'>Hosted by</span>
                        <span className='font-semibold text-blue-600'>TechCorp</span>
                    </p>
                </div>
                ...
                <div className='space-y-4'>
                    ...
                    <p className='text-gray-600 leading-relaxed text-lg'>
                        Join us for an exciting tech conference featuring industry leaders, innovative workshops, and networking opportunities. Learn about the latest trends in technology, participate in hands-on coding sessions, and connect with fellow tech enthusiasts.
                    </p>
                </div>
                ...
                <div className='space-y-4'>
                    ...
                    <ul className='space-y-3 text-gray-600'>
                        {['Keynote speeches from industry experts',
                          ...
                          'Career development sessions'].map((item, index) => (
                ...
                <div className='pt-6'>
                    <button className='bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition-colors duration-300 font-semibold shadow-md hover:shadow-lg transform hover:-translate-y-0.5'>
                        Register Now
                    </button>
                </div>
            </div>
                ...
                <div className='space-y-4'>
                    ...
                    <div className='flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors'>
                        ...
                        <div className='ml-4'>
                            ...
                            <p className='font-bold text-xl text-gray-900'>100</p>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors'>
                        ...
                        <div className='ml-4'>
                            <h3 className='text-sm text-gray-500'>Registration Deadline</h3>
                            <p className='font-bold text-xl text-gray-900'>2025-01-01</p>
                        </div>
                    </div>
                </div>
            </div>
